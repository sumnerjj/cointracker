...
def sync_wallet(wallet_id: int) -> None:  # noqa: C901 – functionally long
    ...
    try:
        while more_data:
            ...
            # Update balance every page (cheap)
            ...
            # Bulk insert – ignore duplicates via constraint
            ...
            # if fewer results than page size -> done
